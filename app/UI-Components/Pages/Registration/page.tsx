              ...
              <div className='border w-[90%] max-w-xl p-10 border-black rounded-2xl'>
                ...
                <div className='space-y-5'>
                  <div className='username-details'>
                    ...
                    <input type="text" placeholder='Enter your username' className='w-full px-4 py-3 border border-black bg-white hover:border-secondary rounded-lg focus:outline-none' />
                  </div>
                  ...
                  <div className='flex items-center justify-center gap-2 mt-8'>
                    <button className='btn bg-black text-white cursor-pointer GolosText px-4 py-2 rounded-md transition-all duration-300'>Register</button>

                    <Link href="/UI-Components/Pages/Login">
                      <button className='btn border hover:bg-secondary text-black hover:text-white cursor-pointer GolosText px-4 py-2 rounded-md transition-all duration-300'>Sign In</button>
                    </Link>
                  </div>
                </div>
              </div>
